  ...
  return (
    <section className="py-12">
      <div className="prose container mx-auto px-6">
        ...
        >
          Professional <span className="bg-gradient-to-r from-emerald-500 via-cyan-500 to-blue-500 dark:from-emerald-400 dark:via-cyan-400 dark:to-blue-400 bg-clip-text text-transparent">Experience</span>
        </motion.h2>
