...
const About = () => {
  return (
    ...
    >
      ...
      >
        Hi there! I'm a Software Developer with <strong>9+ years of experience</strong> currently living in <strong>Bilbao</strong> <Flag code="ES" className="w-8 h-6 inline-block transition-transform transform hover:rotate-12" />
